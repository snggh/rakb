  ...
  return (
    <main>
      <section className="wrap pt-16 pb-12">
        ...
        <h1 className="page-title mb-[1.125rem]">House rules</h1>
        ...
        {rules.map((rule, i) => (
          <Reveal key={rule.no} delay={i * 0.03}>
            <div className="row-lg">
              <div className="pt-1 font-mono text-[0.8125rem] text-[var(--dimmer)]">{rule.no}</div>
              <div>
      ...
      <div className="wrap grid grid-cols-[repeat(auto-fit,minmax(280px,1fr))] gap-4 pt-8 pb-20">
        <Reveal>
          <div className="panel p-7">
            <h4 className="mb-2.5 text-[1.0625rem]">Zero tolerance</h4>
            <p className="m-0 max-w-[52ch] text-sm leading-[1.65] text-[var(--dim)]">{zeroTolerance}</p>
          </div>
        </Reveal>
        <Reveal delay={0.08}>
          <div className="panel p-7">
            <h4 className="mb-2.5 text-[1.0625rem]">Questions before you come?</h4>
            <p className="mb-[1.125rem] max-w-[52ch] text-sm leading-[1.65] text-[var(--dim)]">
              If something here is unclear, ask before the day rather than at the door.
            </p>
            <Link href="/faq" className="btn btn-secondary !px-4 !py-[0.5625rem]">
              Read the FAQ
            </Link>
          </div>
        </Reveal>
