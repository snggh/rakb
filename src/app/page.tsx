    ...
    <main>
      ...
      <div className="band-top">
        <div className="wrap pt-14">
          ...
          <p className="mb-7 max-w-[56ch] text-[var(--dim)]">
            Vol. 2 runs at the{" "}
            <strong className="font-medium text-[var(--color-text)]">{event.venue.fullName}</strong>,{" "}
            {event.venue.address}.
          </p>
        </div>
      ...
      <div className="band-top relative overflow-hidden">
        ...
        <div className="wrap relative pt-16 pb-6">
          ...
          <p className="m-0 max-w-[54ch] text-[var(--dim)]">{sponsorsIntro}</p>
        </div>
