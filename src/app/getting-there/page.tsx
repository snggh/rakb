  ...
  return (
    <main>
      <section className="wrap pt-16 pb-14">
        ...
        <h1 className="page-title mb-[1.125rem]">How to reach the room</h1>
        <p className="mb-3 max-w-[56ch] text-[1.0625rem] leading-[1.6]">
      ...
      <div className="band">
        <div className="wrap cell-grid" style={{ gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))" }}>
          {transport.map((item, i) => (
            <Reveal key={item.kind} delay={i * 0.04} className="cell !py-[1.875rem]">
      ...
      <div className="wrap grid grid-cols-[repeat(auto-fit,minmax(300px,1fr))] gap-8 pt-12 pb-20">
        ...
        <Reveal delay={0.08}>
          ...
          <ul className="m-0 grid list-disc gap-2.5 pl-[1.125rem] text-sm leading-[1.6] text-[var(--dim)]">
