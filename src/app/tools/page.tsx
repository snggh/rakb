  ...
  return (
    <main>
      <section className="wrap pt-16 pb-12">
        ...
        <h1 className="page-title mb-[18px]">Tools for the hobby</h1>
      ...
      <div className="wrap grid grid-cols-[repeat(auto-fit,minmax(320px,1fr))] gap-4 pb-10">
        <div className="panel p-[30px]">
          ...
          <h3 className="mt-[18px] mb-2.5 text-[21px]">Vendor &amp; artisan directory</h3>
          ...
          <div className="mt-[18px] grid">
            {["Shops & distributors", "Artisan makers", "Build & lube services"].map((label) => (
              <div
                key={label}
                className="flex justify-between border-t border-[var(--color-divider)] py-3 text-[13.5px]"
              >
                <span>{label}</span>
        ...
        <div className="panel p-[30px]">
          <span className="tag tag-accent">In progress</span>
          <h3 className="mt-[18px] mb-2.5 text-[21px]">Build guide + parts calculator</h3>
          <p className="text-sm leading-[1.65] text-[var(--dim)]">
          ...
          <div className="mt-[18px] grid">
            ...
            <div className="flex justify-between border-t border-[var(--line-hi)] pt-3.5 text-[15px] font-medium">
      ...
      <div className="wrap pb-20">
        <p className="max-w-[52ch] text-[13px] text-[var(--dimmer)]">
