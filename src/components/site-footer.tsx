  ...
  return (
    <footer className="site-footer">
      <div className="wrap grid grid-cols-[repeat(auto-fit,minmax(200px,1fr))] gap-8 py-12">
        <div>
          <div className="mb-2.5 text-[0.9375rem] font-semibold tracking-[-0.02em] text-[var(--color-text)]">
            {site.name}
          </div>
          <p className="m-0 max-w-[32ch] text-[0.8125rem] leading-[1.6] text-[var(--dimmer)]">
            A mechanical keyboard community. Meetups, group buys, and learning together.
          </p>
        </div>
        <div className="grid gap-[0.5625rem] text-[0.84375rem]">
        ...
        <div className="grid gap-1.5 text-[0.84375rem]">
